...
<head>
  ...
  <title>SIS - <?php echo $user_data['firstName']; ?> </title>
  <!-- plugins:css -->
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="#">Transcript</a></li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="#">Principal Courses</a></li>
                <li class="nav-item"><a class="nav-link" href="#">Electives</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="charts">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="#">Bills &amp; Ballances</a></li>
                <li class="nav-item"><a class="nav-link" href="#">Financial Aid Awards</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="tables">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="#">Spiritual Life</a></li>
                <li class="nav-item"><a class="nav-link" href="#">Sports &amp; Fitness</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Welcome, <?php echo $user_data['firstName']; ?></h3>
                  <h6 class="font-weight-normal mb-0">Below is a summary of your student account. <span class="text-primary">3 unread alerts!</span></h6>
                </div>
                <div class="col-12 col-xl-4">
                  <div class="justify-content-end d-flex">
                    <div class="dropdown flex-md-grow-1 flex-xl-grow-0">
                      <button class="btn btn-sm btn-light bg-white dropdown-toggle" type="button" id="dropdownMenuDate2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                        <i class="mdi mdi-calendar"></i> Today (10 Jan 2022)
                      </button>
                ...
                <div class="card-people mt-auto">
                  ...
                  <div class="weather-info">
                    <div class="d-flex">
                      ...
                      <div class="ml-2">
                        <h4 class="location font-weight-normal">Rwesero</h4>
            ...
            <div class="col-md-6 grid-margin transparent">
              ...
              <div class="row">
                <div class="col-md-6 mb-4 stretch-card transparent">
                  <div class="card card-tale">
                    <div class="card-body">
                      <p class="mb-4">Term III</p>
                      <p class="fs-30 mb-2">83%</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 mb-4 stretch-card transparent">
                  <div class="card card-tale">
                    <div class="card-body">
                      <p class="mb-4">Conduct</p>
                      <p class="fs-30 mb-2">93%</p>
                    </div>
                  </div>
                </div>
              </div>
